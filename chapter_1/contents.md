...
- Making inferences based on available information
...
**Explanation:** All other items are fruits, while a carrot is a vegetable.
...
**Explanation:** The series represents the first letters of months: January, February, March, April, May, June.
...
- \(a \text{ km/h} = a \times \frac{5}{18} \text{ m/s}\)
- \(a \text{ m/s} = a \times \frac{18}{5} \text{ km/h}\)

#### Time Taken by Trains to Pass Objects
...
**Explanation:** We first convert the speed to m/s, then use the formula Time = Total length / Speed to calculate the time taken.
...
**Explanation:** We first calculate the speed in km/h, then convert it to m/s using the conversion formula.
...
1. Problem-solving in professional settings
2. Critical thinking in academic research
3. Decision-making in business and management
4. Logical analysis in computer programming and algorithm design
5. Strategic planning in project management

## Practice Problems

To reinforce the concepts covered in this chapter, try solving the following practice problems:

1. Verbal Reasoning: Complete the analogy - CANVAS : PAINTER :: STAGE : ?
2. Numerical Reasoning: Find the next number in the series: 1, 4, 9, 16, 25, ?
3. Non-verbal Reasoning: Identify the odd one out in a set of geometric shapes.
